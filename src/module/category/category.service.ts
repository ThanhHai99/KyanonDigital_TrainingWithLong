...
export class CategoryService {
  ...
  async create(transactionEntityManager: EntityManager, data: BodyCreateCategory): Promise<any> {
    ...
    await transactionEntityManager
      ...
      .catch((reject) => {
        throw new HttpException('The category cannot create', HttpStatus.INTERNAL_SERVER_ERROR)
      })
  }

  async update(transactionEntityManager: EntityManager, id: number, data: Partial<BodyUpdateCategory>): Promise<any> {
    ...
    await transactionEntityManager
      ...
      .catch((reject) => {
        throw new HttpException('The category cannot update', HttpStatus.INTERNAL_SERVER_ERROR)
      })
  }
}
