import { Body, Controller, Get, Patch, Res, Query, Param, HttpStatus, Post, UseGuards } from '@nestjs/common'
...
export class UserController {
  ...
  @Roles(Role.super_admin)
  @Patch(':id')
  async update(@Body() body: Partial<BodyUpdateUser>, @Res() res, @Param('id') id: number): Promise<any> {
